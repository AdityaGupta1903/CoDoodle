import type { HitCanvas, SceneCanvas } from 'konva/lib/Canvas';
import type { SceneContext } from 'konva/lib/Context';
import type { NodeConfig } from 'konva/lib/Node';
import { Node } from 'konva/lib/Node';
import type { Shape } from 'konva/lib/Shape';
import type { GetSet, IRect } from 'konva/lib/types';
...
export declare abstract class Container<ChildType extends Node = Node> extends Node<ContainerConfig> {
    ...
    clone(obj?: any): this;
    getAllIntersections(pos: any): Shape<import("konva/lib/Shape").ShapeConfig>[];
