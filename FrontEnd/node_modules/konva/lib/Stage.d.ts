...
import type { GetSet, Vector2d } from 'konva/lib/types';
...
export declare class Stage extends Container<Layer> {
    ...
    getIntersection(pos: Vector2d): Shape<import("konva/lib/Shape").ShapeConfig> | null;
    _resizeDOM(): void;
    ...
    _getTargetShape(evenType: any): Shape<import("konva/lib/Shape").ShapeConfig> | null;
